...
echo [1/3] Compilando...
iverilog -o encoder_demux.vvp encoder_demux_tb.v
...
vvp encoder_demux.vvp

if not exist encoder_demux.vcd (
    echo Arquivo encoder_demux.vcd nao gerado!
    pause
    exit /b 1
)
...
start gtkwave encoder_demux.vcd
